      ...
      <div className="about">
          ...
          <div className="width">
            <div className="intro">
              ...
              <div className="desc">
                ...
                <p>
                  <span className="span">Emmanuel Kariga </span> - CEO, in
                  Mireya Desigers Campany.
                </p>
              </div>
        ...
        <div className="width pt">
          <div className="content">
            ...
            <p className="p">
              With a team of experts in branding, digital marketing, and
              creative design, Mireya provides tailored solutions to help
              homeowners showcase their unique style and transform their living
              spaces into stunning works of art. From concept to execution,
              Mireya delivers exceptional results that exceed expectations and
              captivate audiences, ensuring that every home design project is a
              success. Trust Mireya to bring your house design to life and make
          ...
          <div className="content mt ">
            ...
            <div className="col">
              ...
              <div className="cols">
                ...
                <p>
                  Need some home repairs? Trust our team of skilled
                  professionals to fix any issue quickly and efficiently. We'll
                  have your home looking like new in no time.
                </p>
                <Link to="/contact">ORDER A SERVICE</Link>
              </div>
              <div className="cols">
              ...
              <div className="cols">
                ...
                <p>
                  Ready for a home makeover? Our interior design experts will
                  help you transform any space into a beautiful, comfortable
                  retreat. From color schemes to furniture, we've got you
                  covered.
                </p>
                <Link to="/contact">ORDER A SERVICE</Link>
              </div>
