      ...
      <div className="work">
          ...
          <div className="width">
            <div className="intro ">
              ...
              <div className="desc">
                ...
                <p>
                  Protect Your Gear with Our High-Quality Professional Cases.
                </p>
              </div>
        ...
        <div className="width all">
          <div className="content mt">
            ...
            <p className="p">
              <span>
                Our team of experts is committed to transforming your space into
                a beautiful and functional living area that meets your unique
                needs and style. Trust us to bring your dream home to life with
